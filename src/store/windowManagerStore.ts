...
export const APP_DEFINITIONS: AppDefinition[] = [
  ...
  },
  {
    ...
    icon: '📁',
    category: 'System',
    description: 'Browse and manage files through the Phase 2 VFS layer.',
  ...
  },
  {
    ...
    icon: '⌨️',
    category: 'Utilities',
    description: 'Command shell app powered by the shared VFS service.',
  ...
  },
  {
    ...
    icon: '🧾',
    category: 'Productivity',
    description: 'Edit files stored in the virtual filesystem.',
